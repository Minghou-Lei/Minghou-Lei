...
|---|---|---|
| [**Mecha BREAK** · 解限机](https://store.steampowered.com/app/2452280/) | Competitive Mecha Action | Rendering pipeline, lighting, multi-platform quality |
| [**Starsand Island** · 星沙岛](https://store.steampowered.com/app/2966320/) | Sandbox / Casual | Streaming rendering, memory control, environment lighting |
| **Me and My Cat** · 我和我的猫 | Casual / Life Sim | Rendering support, engine integration |
| [**JX3** · 剑网3](https://jx3.xoyo.com) | Wuxia MMORPG (Flagship) | Lighting debug tooling — performance stat panel, overlay heatmap, editor debug switches |
